...
################################################################################
# Pick a dayBase image to serve as the foundation for the other build stages in
# this file.
#
...
#
# The following commands will leverage the "dayBase" stage above to generate
...
# purposes the "dayBase" image is used here.
FROM base AS final
